 ...
 */
int test_node_pointer(int &testNum, const std::string MESSAGE, const Node* LHS, const Node* RHS);
 ...
 * @return 1 if test passed, 0 otherwise
 */
int test_node_pointer_not(int &testNum, const std::string MESSAGE, const Node* LHS, const Node* RHS);
...
/**
 * @brief Pretty prints a header box with label centered in box
 * 
 * @param SECTION_HEADER string to print in header box 
 */
