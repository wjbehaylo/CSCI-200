...
//implimentation of equilateral triangle set coordinates function

bool EquilateralTriangle::setCoordinates(const double x1, const double y1, const double x2, const double y2, const double x3, const double y3){
    ...
    //checking that the sides form an equilateral triangle
    if (side12 == side13 && side12 == side23 && side13 == side23){ //if all the sides are equal in length
    ...
    return false; //this false is only reached if we have a triangle, but then determine it isn't equilateral
